package com.project.report_service.config;
...
public class SecurityConfigReport {
    ...
    @Bean
    public SecurityFilterChain reportSecurityFilterChain(
            HttpSecurity http,
            DefaultAuthenticationEntryPoint entryPoint
    ) throws Exception {
        http.securityMatcher("/api/v1/reports/**");
