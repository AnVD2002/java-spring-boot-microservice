...
public enum SystemError implements AbstractError {
    ...
    ERROR_020(404,"ERROR-020", HttpStatus.NOT_FOUND),
    ERROR_021(400,"ERROR-021", HttpStatus.BAD_REQUEST),
    ERROR_022(404,"ERROR-022", HttpStatus.NOT_FOUND),
    ERROR_023(404,"ERROR-023", HttpStatus.NOT_FOUND),
    ERROR_024(404,"ERROR-024", HttpStatus.NOT_FOUND),
    ERROR_025(404,"ERROR-025", HttpStatus.NOT_FOUND),
    ERROR_026(404,"ERROR-026", HttpStatus.NOT_FOUND),
    ERROR_027(400,"ERROR-027", HttpStatus.BAD_REQUEST),  // Password and confirm password do not match
    ERROR_028(409,"ERROR-028", HttpStatus.CONFLICT),     // Email already registered
    ERROR_029(400,"ERROR-029", HttpStatus.BAD_REQUEST),  // Failed to validate Google token
    ERROR_030(404,"ERROR-030", HttpStatus.NOT_FOUND);
